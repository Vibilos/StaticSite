...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_extract_markdown_links(self):
        matches = extract_markdown_links("Go to [Boot.dev](https://boot.dev)")
    ...
    def test_text_to_textnodes(self):
        raw = "I **love** writing `code` and having _fun_"
        nodes = text_to_textnodes(raw)
        self.assertEqual(
            [
                ...
                TextNode(" and having ", TextType.TEXT),
